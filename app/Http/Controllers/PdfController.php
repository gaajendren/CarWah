...
public function generatePdf()
{
    ...
    $pdf = SnappyPdf::loadView('admin.pdf', compact('product', 'book', 'review' ,'setOrder','rating','total_p' , 't_book' , 'total_sum' , 'bSum' ,'penOrder' ,'labels' , 'values' , 'bSumByWeek','bSumByMonth'));
