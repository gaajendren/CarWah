        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            @include('admin.top_bar')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-black-800">Vechicle</h1>
                        ...
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-9" style="display:flex; align-items:center;">
                                     <h6 class="m-0 font-weight-bold text-black" >Vechicle List</h6> 
                                    </div>
                                <div class="col-3" style="display:flex; justify-content:flex-end;">
                                    <a href="{{route('create.vechicle')}}"><button class="btn btn-primary">Add New Vechicle</button></a>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table style="color:black;" class="table table-bordered" id="dataTable" width="100%" cellspacing="1">
                                    <thead>
                                        <tr>
                                            <th>Vecicyle Type</th>
                                            <th>Have Duration Estimation</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      ...
                                      @foreach ($product as $data)
                                        <tr>
                                            ...
                                            <td>@if ($data->isEstimate == 0)
                                                    <div class="btn btn-success">Have</div>
                                                @else 
                                                <div class="btn btn-danger">Not Have</div>    
                                                @endif
                                            </td>
                                            <td>
