    ...
    <div class="col-xl-12">  
        <div class="card mb-4">
            ...
            <a href="{{route('index.vechicle')}}"><button class="btn btn-primary d-flex ">Back</button></a>
                ...
                <div class="card-body">
                <form action="{{ url('admin/update/vechicle/' .$product->id) }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        @method("PATCH")
                    <div class="col-xl-10">
                               
                    <div class="mb-3"><label for="exampleFormControlInput1"> Vechicle Type: </label><input class="form-control form-control-solid" id="exampleFormControlInput1" value="{{$product->name}}" type="text" name="name" placeholder="Your Service Name" required></div>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlSelect1">Have Estimate Duration: </label><select class="form-control form-control-solid" name="isEstimate" id="exampleFormControlSelect1" required>
                                <option value="0" {{ $product->isEstimate == 0 ? 'selected' : '' }}>Have</option>
                                <option value="1" {{ $product->isEstimate == 1 ? 'selected' : '' }}>Not Have</option>
                            </select>
                        </div>
