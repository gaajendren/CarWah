       ...
       $.ajax({
            ...
            success: function(response) {
                ...
                if (response == 0) {
                    ...
                    $('#duration-input').html('<div class="mb-3"><label for="exampleFormControlInput3">Duration( 1 for 30 minute): </label><input class="form-control form-control-solid" id="exampleFormControlInput3" type="number" name="duration" placeholder="1" required></div>');
                } else if (response == 1) {
